    ...
    (b.onreadystatechange = function () {
      if (4 === b.readyState) {
        ...
        d ||
          ...
          (b._cachedTarget = {})),
          b._embeds.splice(0).map(function (e) {
            var f = b._cachedTarget[e.id];
            f || (f = b._cachedTarget[e.id] = d.getElementById(e.id)),
              a(e.parent, e.svg, f, c);
          });
      }
    }),
