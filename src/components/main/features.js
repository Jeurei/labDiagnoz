  ...
  <section className="main__section main__section-features section features">
    <SectionInner>
      <h2 className="section__title">
        Почему именно
        <Picture src="./img/features-logo" imgClass="features__logo-img" alt="Лабдиагностика" />
      </h2>
...
export default connect(mapStateToPropsGenerator(components.FEATURES), null)(Features);
